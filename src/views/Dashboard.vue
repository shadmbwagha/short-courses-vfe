<template>
    <div class="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-2 sm:px-8">
        ...
        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            <div class="p-4 bg-red-400"><img src="../assets/images/cash.svg" class="h-12 w-12 text-white" style="color:white"></div>
            <div class="px-4 text-gray-700">
        ...
        <div class="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-2 sm:px-8">
            <div class="">
                <router-link to="/creditForm">
                    <button class="px-6 py-2 text-white bg-blue-500 rounded-sm text-md w-full">+ Add student</button>
                </router-link>
            </div>
            <div>
                <router-link to="/creditForm">
                    <button class="px-6 py-2 text-white bg-blue-500 rounded-sm text-md w-full">+ Payments</button>
                </router-link>
            </div> 
        </div>
    </div>
